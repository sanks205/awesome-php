...
* [Observer](https://github.com/sanks205/getobserver) - An offline CLI that scans a codebase for security & production-health issues and outputs one HTML report (multi-language, dependency CVEs, single binary).
